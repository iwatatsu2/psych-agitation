...
export const levels: Level[] = [
  {
    ...
    steps: [
      "【最優先】環境調整：時計・カレンダーの設置（見当識の維持）、日中の離床促進（車椅子でナースステーションへ等）、刺激の軽減、静かな場所への移動、他患者との距離確保",
      "傾聴・共感的対応、要望の確認",
      "口頭での落ち着きの促し（ディエスカレーション）",
      "環境調整で改善しない場合 → 頓服薬の提案・投与",
      "15〜30分後に再評価",
    ],
    drugs: [
      {
    ...
    drugs: [
      {
        ...
        dose: "1mg",
        onset: "30〜60分",
        notes: "まず内服を試みる。液剤で服用しやすい。糖尿病患者には注意",
        category: "antipsychotic",
      },
      {
        name: "オランザピン筋注",
  ...
  },
  {
    ...
    drugs: [
      ...
      },
      {
        name: "ハロペリドール",
        route: "筋注/静注",
        dose: "筋注5mg / 静注5mg（緩徐に）",
        onset: "筋注15〜30分 / 静注5〜10分",
        notes:
